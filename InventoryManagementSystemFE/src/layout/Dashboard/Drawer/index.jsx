...
import newlogo from 'assets/images/UWU=BANNER.png'
    ...
    <nav id="pc-sidebar" className={`pc-sidebar ${drawerOpen ? 'pc-sidebar-hide mob-sidebar-active' : ''} `}>
      <div className="navbar-wrapper">
        <div className="m-header">
          <a className="b-brand text-primary" style={{ display: "flex", justifyContent: "center" }}>
            <Image src={newlogo} fluid className="logo logo-lg" alt="logo" style={{ width: '80%', justifyContent: 'center' }} />
          </a>
        </div>
